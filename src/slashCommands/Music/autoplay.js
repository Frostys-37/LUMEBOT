...
module.exports = {
  name: "autoplay",
  description: "Activa el autoplay.",
  player: true,
  category: "Music",
  inVoiceChannel: true,
  ...
  run: async (client, interaction) => {
    ...
    if (!player.queue.current)
      return interaction.reply({
        content: `Usa el /play antes que este por favor..`,
      });
    ...
    if (autoplay) {
      ...
      let thing = new EmbedBuilder()
        ...
        .setTimestamp()
        .setDescription(`${emojireplay} Autoplay **deshabilitado**.`);
      ...
      let thing = new EmbedBuilder()
        .setColor(client.embedColor)
        .setTimestamp()
        .setDescription(`${emojireplay} Autoplay **habilitado**.`);
