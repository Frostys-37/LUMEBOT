...
module.exports = async (client, player) => {
	...
	client.logger.log(`Cola destruida en: ${player.guild}`, "log");
	...
	let embed1 = new EmbedBuilder().setColor(client.embedColor).setTitle(`No escuchando nada ahora mismo.`).setImage(client.config.links.img);
	...
	await message.edit({
		content: "__**Unase al canal de voz y ponga las canciones con nombre/url.**__\n\n",
		embeds: [embed1],
		components: [row1]
	});
